...
db.once("open", function () {
    ...
    app.post("/update", function (req, res) {
        if (req.session.loggedIn) {
            ...
            Booking.findByIdAndUpdate(
                req.body.id,
                { $set: { truckname: req.body.truckname, truckno: req.body.truckno, currentlocation: req.body.location, price: req.body.price, ptype: req.body.ptype, tphone: req.body.tphone, status:req.body.status, drname: req.body.drname, drphone: req.body.drphone} },
                function (err, docs2) {
    ...
    app.get('/login-error', function (req, res) {
        ...
        res.render('log-in', { mess: mess, flag:flag });
    });
        ...
        if (req.session.loggedIn) {
            ...
            Booking.find({ currentlocation: req.body.pickup, status: "free" }, function (err, docs) {
                ...
                if(pickup1==drop1){
                    ...
                    res.render("booking",{mess1: mess1});
                }
                else{
                    const location=["Chennai","Trichy","Salem","Madurai","Tenkasi","Kanyakumari"];
    ...
    app.get("/log-in", function (req, res) {
        flag=0;
        res.render("log-in", { mess: mess, falg:flag });
    });
